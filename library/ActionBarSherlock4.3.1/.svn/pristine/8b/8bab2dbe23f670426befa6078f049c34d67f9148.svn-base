...
public class SearchView extends LinearLayout implements CollapsibleActionView {
    ...
    private boolean hideSuggestionOnKeyBoardHide = true;
    ...
    */
    ...
    public SearchView(Context context, AttributeSet attrs) {
        ...
        mQueryTextView.setOnTouchListener(new OnTouchListener() {
    ...
    /**
     * Sets the nature of searchview when keyboard is hidden. By default when keyboard is hidden search suggestions
     * are also hidden. Setting it to false will show the search suggestion when keyboard is still hidden.
     * @param hideStatus true to hide with keyboard, false to still show when keyboard hidden
     */
    public void setHideSuggestionOnKeyBoardHide(boolean hideStatus){
    	hideSuggestionOnKeyBoardHide = hideStatus;
    }
    ...
    private void updateViewsVisibility(final boolean collapsed) {
        ...
        mQueryTextView.setImeOptions(mCollapsedImeOptions | EditorInfo.IME_FLAG_NO_FULLSCREEN | EditorInfo.IME_ACTION_SEARCH);
        updateCloseButton();
    ...
    public static class SearchAutoComplete extends AutoCompleteTextView {
        ...
        protected void onFocusChanged(boolean focused, int direction, Rect previouslyFocusedRect) {
            ...
            if(focused==true){
            	mSearchView.mKeyboardVisible = true;
            } else{
            	mSearchView.mKeyboardVisible = false;
            }
        }
        ...
        public boolean onKeyPreIme(int keyCode, KeyEvent event) {
            if (keyCode == KeyEvent.KEYCODE_BACK) {
                ...
                if (event.getAction() == KeyEvent.ACTION_DOWN && event.getRepeatCount() == 0) {
                    ...
                    if(mSearchView.mKeyboardVisible == false){
//                    	mSearchView.onActionViewCollapsed();
                    ...
                    if (event.isTracking() && !event.isCanceled()) {
                        if(mSearchView.hideSuggestionOnKeyBoardHide)
                        	mSearchView.clearFocus();
