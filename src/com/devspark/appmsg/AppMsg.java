...
public class AppMsg {
    ...
    /**
     * Show the text notification for a infinite period of time with a neutral style.
     */
    public static final Style STYLE_ALERT_ALWAYS_VISIBLE = new Style(-1, R.color.alert);
