		...
		mDiscoveryListener = new NsdManager.DiscoveryListener() {
			...
			public void onServiceFound(NsdServiceInfo service) {
                ...
                if (type.equals(SERVICE_TYPE)
						&& (requiredServiceName.trim().equals("sinepulsemctest1")
								|| requiredServiceName.trim().equals("sinepulsemcpwd")
								|| requiredServiceName.trim().equals("sinepulsemcict1") || requiredServiceName
								.trim().equals("sinepulsemcict2")|| requiredServiceName
								.trim().equals("sinepulsemchp")|| requiredServiceName
								.trim().equals("sinepulsemc"))) {
					Log.d("NSD", "Service Found @ '" + name + "'");
					try {
//						if(requiredServiceName.equalsIgnoreCase("sinepulsemcdev")|| requiredServiceName.equalsIgnoreCase("sinepulsemcdev.local")){
