...
public class CircularSeekBar extends View {
	...
	private static final float DEFAULT_POINTER_HALO_BORDER_WIDTH = 2.5f;
	private static final float DEFAULT_CIRCLE_STROKE_WIDTH = 4f;
	private static final float DEFAULT_START_ANGLE = 279f; // Geometric (clockwise, relative to 3 o'clock)
	private static final float DEFAULT_END_ANGLE = 262f; // Geometric (clockwise, relative to 3 o'clock)
	private static final int DEFAULT_MAX = 100;
	private static final int DEFAULT_PROGRESS = 0;//Color.rgb(190, 190, 190)
	private static final int DEFAULT_CIRCLE_COLOR =Color.rgb(190, 190, 190) ;
