		...
		public void onReceive(Context context, Intent intent) {
			if (activityVisible) {
				if (CommonTask.isNetworkAvailable(MainActionbarBase.this) == false) {
					...
					msg.show();
					//check if it is from login screen or not...if so do nothing.else back to login screen
					...
					if (runningactivities.contains("ComponentInfo{com.sinepulse.app/com.sinepulse.app.activities.UserLogin_}") == true) {
						// return true;
						return;
					}else{
...
//			fragment = userlogFragment;
		...
		case SETTINGS_FRAGMENT:
			...
			Intent userProfileIntent = new Intent(this, UserProfileActivity_.class);
...
//			break;
			Intent changePassIntent = new Intent(this, ChangePasswordActivity_.class);
...
//					.beginTransaction();
//			
//		/*	if(fragment==cameraStreamFragment){
//			     fragtmentTransaction.remove(cameraStreamFragment);
////			     currentFragment = fragmentBackStack.pop();
//			}*/
//			
//			
//			if (replace) {
