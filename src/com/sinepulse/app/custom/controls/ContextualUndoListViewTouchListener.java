...
public class ContextualUndoListViewTouchListener implements View.OnTouchListener {
    ...
    public ContextualUndoListViewTouchListener(AbsListView basketListView, Callback callback) {
        ViewConfiguration vc = ViewConfiguration.get(basketListView.getContext());
        mSlop = vc.getScaledTouchSlop();
        mMinFlingVelocity = vc.getScaledMinimumFlingVelocity();
        mMaxFlingVelocity = vc.getScaledMaximumFlingVelocity();
        mAnimationTime = basketListView.getContext().getResources().getInteger(
                android.R.integer.config_shortAnimTime);
        mListView = basketListView;
        mCallback = callback;
    }
