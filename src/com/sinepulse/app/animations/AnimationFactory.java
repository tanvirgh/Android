...
public class AnimationFactory {
         ...
         */
        public static void flipTransition(final ViewAnimator viewAnimator, FlipDirection dir,InputMethodManager imm, int keyboardStatus,int rotateTime) {   
                ...
                final Animation[] animc = AnimationFactory.flipAnimation(fromView, toView, (nextIndex < currentIndex?dir.theOtherDirection():dir), rotateTime, null);
				...
				//
				if (imm != null) {					
					imm.toggleSoftInput(keyboardStatus, keyboardStatus);
				}                
         ...
         * @param dir the direction of flip
         */
        public static void flipTransition(final ViewAnimator viewAnimator, FlipDirection dir,InputMethodManager imm, int keyboardStatus,int rotateTime, AnimationListener animListener) {   
                ...
                if(animListener!=null){
                	animc[0].setAnimationListener(animListener);
                	animc[1].setAnimationListener(animListener);
                }
